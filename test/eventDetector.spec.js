...
describe('Event detector service', () => {
    ...
    it('Fails to create a no change detector', () => {
    	...
    	return client.restRequest({
    		...
    		throw "No change detector created despite having a duration of zero."
    	}).catch(response => {
    		if(!(typeof response.response.statusMessage === 'string') || response.response.statusMessage.indexOf("Unprocessable Entity") == -1)
    			throw "Received non-string or non 422 response: " + response.response.statusMessage;
    		assert.equal(response.response.statusCode, 422);
    ...
    it('Fails to create a state change count detector', () => {
    	...
    	return client.restRequest({
    		...
    		throw "State change count detector created despite 1 change in 0s"
    	}).catch(response => {
    		if(!(typeof response.response.statusMessage === 'string') || response.response.statusMessage.indexOf("Unprocessable Entity") == -1)
    			throw "Received non-string or non 422 response: " + response.response.statusMessage;
    		assert.equal(response.response.statusCode, 422);
    ...
    it('Fails to create an alphanumeric regex detector', () => {
    	...
    	return client.restRequest({
    		...
    		throw "Alphanumeric regex event detector created even without a valid regex."
    	}).catch(response => {
    ...
    it('Fails to create an analog change detector', () => {
    	...
    	return client.restRequest({
    		...
    		throw "Analog change detector created that doesn't check for analog changes"
    	}).catch(response => {
    		if(typeof response.response === 'undefined')
    			throw response;
    		if(!(typeof response.response.statusMessage === 'string') || response.response.statusMessage.indexOf("Unprocessable Entity") == -1)
    ...
    it('Fails to create an analog high limit detector', () => {
    	...
    	return client.restRequest({
    		...
    		throw "High limit with invalid reset configuration created"
    	}).catch(response => {
    		if(typeof response.response === 'undefined')
    			throw response;
    		if(!(typeof response.response.statusMessage === 'string') || response.response.statusMessage.indexOf("Unprocessable Entity") == -1)
    ...
    it('Fails to create an analog low limit detector', () => {
    	...
    	return client.restRequest({
    		...
    		throw "Low limit with invalid reset configuration created"
    	}).catch(response => {
    		if(typeof response.response === 'undefined')
    			throw response;
    		if(!(typeof response.response.statusMessage === 'string') || response.response.statusMessage.indexOf("Unprocessable Entity") == -1)
    ...
    it('Fails to create an analog range detector', () => {
    	...
    	return client.restRequest({
    		...
    		throw "Analog range detector created with invalid range"
    	}).catch(response => {
    		if(typeof response.response === 'undefined')
    			throw response;
    		if(!(typeof response.response.statusMessage === 'string') || response.response.statusMessage.indexOf("Unprocessable Entity") == -1)
    ...
    it('Fails to create an analog negative cusum detector', () => {
    	...
    	return client.restRequest({
    		...
    		throw "Analog negative cusum detector created with invalid weight"
    	}).catch(response => {
    		if(typeof response.response === 'undefined')
    			throw response;
    		if(!(typeof response.response.statusMessage === 'string') || response.response.statusMessage.indexOf("Unprocessable Entity") == -1)
    ...
    it('Fails to create an analog positive cusum detector', () => {
    	...
    	return client.restRequest({
    		...
    		throw "Analog positive cusum detector created with invalid limit"
    	}).catch(response => {
    		if(typeof response.response === 'undefined')
    			throw response;
    		if(!(typeof response.response.statusMessage === 'string') || response.response.statusMessage.indexOf("Unprocessable Entity") == -1)
    ...
    it('Fails to create a multistate state detector', () => {
    	...
    	return client.restRequest({
    		...
    		throw "Multistate state detector created with invalid duration"
    	}).catch(response => {
    		if(typeof response.response === 'undefined')
    			throw response;
    		if(!(typeof response.response.statusMessage === 'string') || response.response.statusMessage.indexOf("Unprocessable Entity") == -1)
